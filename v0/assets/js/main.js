...
function handleResize() {
  ...
  figure.style('height', figHeight + 'px').style('top', figMarginTop + 'px');

  figure2.style('height', figHeight + 'px').style('top', figMarginTop + 'px');
...
function init() {
  ...
  d3.csv('./assets/data/overall_analysis_v2.csv', row_converter, dataset => {
